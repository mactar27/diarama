...
export const products: Product[] = [
  // Parfums
  {
    ...
    images: ["/images/products/suddenly-femelle.jpg", "/images/products/suddenly-femelle-2.jpg"],
    stock: 25,
    rating: 4.8,
    reviews: 124,
    featured: true,
  ...
  },
  {
    ...
    images: ["/images/products/suddenly-mystique.jpg", "/images/products/suddenly-mystique-2.jpg"],
    stock: 18,
    rating: 4.9,
    reviews: 89,
    featured: true,
